...
tests = Test.create!([
                       ...
                       { title: 'Personal pronouns', category: categories[1], author: users[0], remaining_time: 60 },
                       { title: 'HTTP protocol', category: categories[0], author: users[1], remaining_time: 60 },
                       { title: 'ORM', category: categories[0], author: users[1], level: 5, remaining_time: 60 },
                       { title: 'Rails models', category: categories[0], author: users[1], level: 2, remaining_time: 60 },
                       { title: 'Windows', category: categories[2], author: users[0], remaining_time: 60 }
                     ])
# Questions
